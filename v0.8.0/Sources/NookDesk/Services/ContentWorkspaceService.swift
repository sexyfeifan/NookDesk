...
final class ContentWorkspaceService {
    ...
    func workspaces(for project: BlogProject, config: ThemeConfig) -> [LanguageProfile] {
    ...
    private func translationIdentity(for post: BlogPost, workspace: LanguageProfile, projectRoot: URL) -> String {
    ...
    private func deduplicated(_ profiles: [LanguageProfile]) -> [LanguageProfile] {
        var seen = Set<String>()
