...
final class CredentialStore {
    ...
    private let githubTokenClassicService = "com.nookdesk.github.token.classic"
    private let githubTokenFineGrainedService = "com.nookdesk.github.token.fine-grained"
    private let aiAPIKeyService = "com.nookdesk.ai.api-key"
    ...
    private func applicationSupportURL() -> URL {
        fm.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
            .appendingPathComponent("NookDesk", isDirectory: true)
    }
}
